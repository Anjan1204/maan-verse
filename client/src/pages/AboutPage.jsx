...
const AboutPage = () => {
    ...
    const team = [
        ...
        { name: 'Anjani Kumar', role: 'Co-Founder & CTO', image: '/assets/Anjan pic.jpeg' },
    ];
    ...
    return (
        <div className="min-h-screen pt-24 pb-12 bg-dark">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About <span className="text-gradient">MAAN-verse</span></h1>
